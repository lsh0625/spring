                    ...
                    <ul class="app_list">
                        <li class="clear">
                            ...
                            <div class="app_content email_area">
                                <input type="text" class="w160" name="member_id" id="email_lbl" title="이메일 주소" />
                        ...
                        <li class="clear">
                            ...
                            <div class="app_content"><textarea id="content_lbl" class="w100p" name="" placeholder="간단한 상담 요청 사항을 남겨주시면 보다 상세한 상담이 가능합니다.
